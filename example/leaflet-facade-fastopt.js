...
/** @constructor */
function $c_Lcom_cibo_leaflet_LatLng$() {
  $c_O.call(this)
}
$c_Lcom_cibo_leaflet_LatLng$.prototype = new $h_O();
$c_Lcom_cibo_leaflet_LatLng$.prototype.constructor = $c_Lcom_cibo_leaflet_LatLng$;
/** @constructor */
function $h_Lcom_cibo_leaflet_LatLng$() {
  /*<skip>*/
}
$h_Lcom_cibo_leaflet_LatLng$.prototype = $c_Lcom_cibo_leaflet_LatLng$.prototype;
$c_Lcom_cibo_leaflet_LatLng$.prototype.init___ = (function() {
  return this
});
$c_Lcom_cibo_leaflet_LatLng$.prototype.apply__D__D__Lcom_cibo_leaflet_LatLng = (function(latitude, longitude) {
  return new $g.L.LatLng(latitude, longitude)
});
var $d_Lcom_cibo_leaflet_LatLng$ = new $TypeData().initClass({
  Lcom_cibo_leaflet_LatLng$: 0
}, false, "com.cibo.leaflet.LatLng$", {
  Lcom_cibo_leaflet_LatLng$: 1,
  O: 1
});
$c_Lcom_cibo_leaflet_LatLng$.prototype.$classData = $d_Lcom_cibo_leaflet_LatLng$;
var $n_Lcom_cibo_leaflet_LatLng$ = (void 0);
function $m_Lcom_cibo_leaflet_LatLng$() {
  if ((!$n_Lcom_cibo_leaflet_LatLng$)) {
    $n_Lcom_cibo_leaflet_LatLng$ = new $c_Lcom_cibo_leaflet_LatLng$().init___()
  };
  return $n_Lcom_cibo_leaflet_LatLng$
}
/** @constructor */
function $c_jl_Class() {
  $c_O.call(this);
...
/** @constructor */
function $c_Ldemo_LeafletExample$() {
  $c_O.call(this)
}
$c_Ldemo_LeafletExample$.prototype = new $h_O();
$c_Ldemo_LeafletExample$.prototype.constructor = $c_Ldemo_LeafletExample$;
/** @constructor */
function $h_Ldemo_LeafletExample$() {
  /*<skip>*/
}
$h_Ldemo_LeafletExample$.prototype = $c_Ldemo_LeafletExample$.prototype;
$c_Ldemo_LeafletExample$.prototype.init___ = (function() {
  return this
});
$c_Ldemo_LeafletExample$.prototype.main__V = (function() {
  var qual$1 = $g.L.map("demo-map");
  var x$1 = $m_Lcom_cibo_leaflet_LatLng$().apply__D__D__Lcom_cibo_leaflet_LatLng(51.505, (-0.09));
  var leafletMap = qual$1.setView(x$1, 13.0);
  $g.L.tileLayer("http://server.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer/tile/{z}/{y}/{x}").addTo(leafletMap);
  var col = $m_sc_Seq$().apply__sc_Seq__sc_GenTraversable(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$m_Lcom_cibo_leaflet_LatLng$().apply__D__D__Lcom_cibo_leaflet_LatLng(51.509, (-0.08)), $m_Lcom_cibo_leaflet_LatLng$().apply__D__D__Lcom_cibo_leaflet_LatLng(51.503, (-0.06)), $m_Lcom_cibo_leaflet_LatLng$().apply__D__D__Lcom_cibo_leaflet_LatLng(51.51, (-0.047))]));
  var this$3 = $m_sjsr_package$();
  if ($is_sjs_js_ArrayOps(col)) {
    var x2 = $as_sjs_js_ArrayOps(col);
    var coords = x2.scala$scalajs$js$ArrayOps$$array$f
  } else if ($is_sjs_js_WrappedArray(col)) {
    var x3 = $as_sjs_js_WrappedArray(col);
    var coords = x3.array$6
  } else {
    var result = [];
  ...
  $g.L.polygon([coords]).addTo(leafletMap)
});
$c_Ldemo_LeafletExample$.prototype.$$js$exported$meth$main__O = (function() {
  this.main__V()
});
$c_Ldemo_LeafletExample$.prototype.main = (function() {
  return this.$$js$exported$meth$main__O()
});
var $d_Ldemo_LeafletExample$ = new $TypeData().initClass({
  Ldemo_LeafletExample$: 0
}, false, "demo.LeafletExample$", {
  Ldemo_LeafletExample$: 1,
  O: 1,
  sjs_js_JSApp: 1
});
$c_Ldemo_LeafletExample$.prototype.$classData = $d_Ldemo_LeafletExample$;
var $n_Ldemo_LeafletExample$ = (void 0);
function $m_Ldemo_LeafletExample$() {
  if ((!$n_Ldemo_LeafletExample$)) {
    $n_Ldemo_LeafletExample$ = new $c_Ldemo_LeafletExample$().init___()
  };
  return $n_Ldemo_LeafletExample$
}
$e.demo = ($e.demo || {});
$e.demo.LeafletExample = $m_Ldemo_LeafletExample$;
/** @constructor */
...
//# sourceMappingURL=leaflet-facade-fastopt.js.map
